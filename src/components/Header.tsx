    ...
    <header className="flex flex-row pl-[208px] pr-[226px] responsive-header">
        <div className='py-3 flex flex-row header-content'>
            ...
            <div className='flex flex-row pl-[183px] pr-[176px] items-center header-nav-item'>
                <Link className='text-white text-lg font-semi-bold leading-7 pr-[61px] nav-item-tag' href='/'>Home</Link>
                <Link className='text-white text-lg font-semi-bold leading-7 pr-[61px] nav-item-tag' href='/'>Service</Link>
                <Link className='text-white text-lg font-semi-bold leading-7 pr-[61px] nav-item-tag' href='/products'>Products</Link>
                <Link className='text-white text-lg font-semi-bold leading-7 pr-[61px] nav-item-tag' href='/aboutus'>About Us</Link>
                <Link className='text-white text-lg font-semi-bold leading-7 pr-[61px] nav-item-tag' href='/pricing'>Prices</Link>
