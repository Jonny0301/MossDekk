    ...
    return (
        <div className='flex relative w-[100%] justify-center items-end'>
            ...
            <div className='flex flex-col justify-center items-center absolute gap-[26px] main-back-pan'>
                <div><p className="text-white text-4xl font-semi-bold font-['Inter'] leading-10 main-back-title uppercase">{pathname == "/aboutus" ? "About Us" : pathname == "/report" ? "DEKK RAPPORT" : renamePathname(pathname)}</p></div>
                <div className='flex flex-row gap-[4px] justify-center items-center mb-[58px] main-back-url-info'>
                    ...
                    {(currentSection)
                        ...
                        </> : <p className="text-[#73c018] text-lg font-medium font-['Inter'] leading-7 uppercase">{pathname == "/aboutus" ? "about" : pathname == "/pricing" ? "pricing" : pathname == "/contact" ? "contact" : pathname=="/products"?"products":""}</p>
                    }
                </div>
            </div>
        </div>
