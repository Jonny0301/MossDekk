            ...
            <div className='flex flex-col justify-center items-center absolute gap-[26px] main-back-pan'>
                ...
                <div className='flex flex-row gap-[4px] justify-center items-center mb-[58px] main-back-url-info'>
                    ...
                    {(currentSection)
                        ...
                        </> : <p className="text-[#73c018] text-lg font-medium font-['Inter'] leading-7 uppercase">{pathname == "/aboutus" ? "about" : pathname == "/pricing" ? "pricing" : pathname == "/contact" ? "contact" : pathname=="/products"?"products":pathname=="/terms"||pathname=="/privacy"?"TERMS AND CONDITION":pathname=="/pdetail"?"products":""}</p>
                    }
                </div>
            </div>
        </div>
