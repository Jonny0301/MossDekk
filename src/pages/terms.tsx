            ...
            <main style={{ "width": '100%' }}>
                <div className="main-container flex flex-col justify-center w-[100%]">
                    ...
                    <div className="terms-body flex flex-row pt-[59px] px-52 pb-[154px] bg-white gap-[51px] max-[1700px]:px-20 max-[1024px]:pb-[75px] max-[1700px]:gap-[18px] max-[800px]:px-4">
                        <div className="flex flex-col w-[390px] h-auto max-[1700px]:gap-[18px] max-[1023px]:w-[206px] max-[660px]:hidden">
                            <div className="flex w-full">
                                <span className="flex text-lg leading-7 font-semi-bold text-[#73C018] max-[1460px]:text-base max-[1460px]:leading-6 max-[1460px]:font-normal">Kjøpsvilkår - Kjøpsvilkår</span>
                            </div>
                            <div className="flex w-full">
                                <span className="flex text-lg leading-7 font-normal text-black max-[1460px]:text-base max-[1460px]:leading-6 max-[1460px]:font-normal ">Kjøpsvilkår - Betaling</span>
                            </div>
                            <div className="flex w-full">
                                <span className="flex text-lg leading-7 font-normal text-black max-[1460px]:text-base max-[1460px]:leading-6 max-[1460px]:font-normal">Kjøpsvilkår - Leveranser</span>
                            </div>
                            <div className="flex w-full">
                                <span className="flex text-lg leading-7 font-normal text-black max-[1460px]:text-base max-[1460px]:leading-6 max-[1460px]:font-normal">Kjøpsvilkår - Returer & reklamasjoner</span>
                            </div>
                            <div className="flex w-full">
                                <span className="flex text-lg leading-7 font-normal text-black max-[1460px]:text-base max-[1460px]:leading-6 max-[1460px]:font-normal">Personvern</span>
                            </div>
                            <div className="flex w-full">
                                <span className="flex text-lg leading-7 font-normal text-black max-[1460px]:text-base max-[1460px]:leading-6 max-[1460px]:font-normal">Cookies</span>
                            </div>
                        </div>
                        <div className="flex flex-col w-[1063px] h-auto max-[1023px]:w-[640px]">
